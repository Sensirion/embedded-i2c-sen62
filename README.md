# Sensirion I2C SEN62 embedded Library

This document explains how to set up a SEN62 sensor
...
Use the following description to connect your SEN62:
...
5. Run the compiled executable with `./sen62_i2c_example_usage`
...
5. Run the compiled executable with `./sen62_test_hw_i2c`.
